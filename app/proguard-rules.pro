...
# utilcode 忽略混淆会导致华为市场报病毒,故不要忽略混淆
...
-keepclassmembers class com.readystatesoftware.chuck.** { *; }
...
-keepclassmembers class com.hss01248.** { *; }
...
####################################push消息###################################
-keep class com.bc.push.bean.**{*;}

-keep class com.github.moduth.blockcanary.** { *; }
-keep class hexin.androidbitmapcanary.** { *; }
